...
namespace App\Actions\GenerateAvailableSlots;
...
{
    public function execute(Provider $provider, int $daysAhead = 30, int $slotMinutes = 30, ?int $serviceId = null): ServiceResponse
    {
        $duration = $serviceId
