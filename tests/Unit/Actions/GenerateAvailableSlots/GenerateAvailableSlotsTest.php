...
class GenerateAvailableSlotsTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->generateAvailableSlots = new GenerateAvailableSlots();
    }
    ...
    public function returns_slots_for_provider_with_working_hours()
    {
        ...
        $result = $this->generateAvailableSlots->execute($provider, 2, 30);
        $slots = $result->data;
    ...
    public function respects_service_duration_when_generating_slots()
    {
        ...
        $result = $this->generateAvailableSlots->execute($provider, 2, 60, $service->Service_ID);
        $slots = $result->data;
    ...
    public function returns_empty_when_provider_has_no_working_hours()
    {
        ...
        $result = $this->generateAvailableSlots->execute($provider, 7, 30);
        $slots = $result->data;
    ...
    public function only_returns_future_slots()
    {
        ...
        $result = $this->generateAvailableSlots->execute($provider, 1, 30);
        $slots = $result->data;
